...
source ~/.git-completion.bash # Include Git autocompletion script (github.com/git/git/master/contrib/completion/git-completion.bash)
...
# Hostname autocompletion for ssh, scp and sftp commands
